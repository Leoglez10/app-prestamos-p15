...
[![Versión](https://img.shields.io/badge/versi%C3%B3n-0.12.0-blue)](CHANGELOG.md)
...
1. **Consigue el instalador.** Es un archivo que termina en `.exe` o `.msi` (por ejemplo `App Prestamos P15_0.12.0_x64-setup.exe`). Hay dos formas:
...
├── msi/App Prestamos P15_0.12.0_x64_en-US.msi
└── nsi/App Prestamos P15_0.12.0_x64-setup.exe
```
...
Usamos versionado semántico `MAYOR.MENOR.PARCHE`. La versión actual es **0.12.0**.
